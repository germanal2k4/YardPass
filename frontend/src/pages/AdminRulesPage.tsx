            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                  Интервал по местным часам жильца (по умолчанию московское, Europe/Moscow), когда вход по пропуску недоступен. Если
                  срок гостя заходит в этот интервал, срок действия пропуска в боте автоматически укорачивается до начала тихих часов (с
                  пояснением). В базе хранится только пара HH:mm.
                </Typography>
              </Grid>
