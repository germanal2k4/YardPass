...
var rootCmd = &cobra.Command{
	Use:   "yardpass-bot",
	Short: "YardPass Telegram bot",
	Long:  "YardPass Telegram bot is a Telegram bot for the YardPass parking management system.",
	RunE: func(cmd *cobra.Command, args []string) error {
		app, err := setup.SetupBot(rootParams.ConfigPath)
		if err != nil {
